...
const traducciones = {
  es: {
    ...
    docente: {
      ...
      salir: 'Salir sin finalizar',
      salir_titulo: '¿Salir sin cerrar la sesión?',
      salir_confirmar: 'Salir y cerrar sesión',
  ...
  en: {
    ...
    docente: {
      ...
      salir: 'Leave without finishing',
      salir_titulo: 'Leave without ending the session?',
      salir_confirmar: 'Leave and end session',
  ...
  gl: {
    ...
    docente: {
      ...
      salir: 'Saír sen rematar',
      salir_titulo: 'Saír sen pechar a sesión?',
      salir_confirmar: 'Saír e pechar a sesión',
      campos_titulo: '{aula} — sesión iniciada',
